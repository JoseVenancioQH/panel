 ...
 * Paperg add the text and plaintext to the selectors ffile_get_or the find syntax.  plaintext implies text in the innertext of a node.  text implies that the tag is a text node.
