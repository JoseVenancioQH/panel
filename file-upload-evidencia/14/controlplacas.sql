...
CREATE TABLE `cat_almacen`  (
  ...
  `cat_almacen_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_almacen_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_cobros`  (
  ...
  `cat_cobros_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_cobros_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_empresa`  (
  ...
  `cat_empresa_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_empresa_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_marcas_unidades`  (
  ...
  `cat_marcas_unidades_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_marcas_unidades_fechaactualizada` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_modelos_unidades`  (
  ...
  `cat_modelos_unidades_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_modelos_unidades_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_operadores`  (
  ...
  `cat_operadores_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_operadores_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_periodopago`  (
  ...
  `cat_periodopago_fechainicio` datetime(0) NULL DEFAULT NULL,
  `cat_periodopago_status` tinyint(4) NULL DEFAULT NULL,
  `cat_periodopago_diascondonados` int(11) NULL DEFAULT NULL,
  `cat_periodopago_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_periodopago_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_permisionario`  (
  ...
  `cat_permisionario_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_permisionario_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_placas_unidades`  (
  ...
  `cat_placas_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_placas_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_rol_unidades`  (
  ...
  `cat_rol_unidades_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_rol_unidades_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_servicio_unidades`  (
  ...
  `cat_servicio_unidades_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_servicio_unidades_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_statusfianzas`  (
  ...
  `cat_statusfianzas_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_statusfianzas_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_unidades`  (
  ...
  `cat_unidades_fechaactualizada` datetime(0) NULL DEFAULT NULL,
  `cat_unidades_fecharegistro` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_vincularfianza`  (
  ...
  `cat_vincularfianza_fecha` datetime(0) NULL DEFAULT NULL,
  ...
  `cat_vincularfianza_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_vincularfianza_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_vincularpermisionario`  (
  ...
  `cat_vincularpermisionario_fechainicio` datetime(0) NULL DEFAULT NULL,
  `cat_vincularpermisionario_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_vincularpermisionario_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `cat_zonas_unidades`  (
  ...
  `cat_zonas_unidades_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `cat_zonas_unidades_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `reg_movimientos`  (
  ...
  `reg_movimientos_fechahora` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `reg_pagosfianzas`  (
  ...
  `reg_pagosfianzas_fecharegistro` datetime(0) NULL DEFAULT NULL,
  `reg_pagosfianzas_fechaactualiza` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `reg_pagospermisionarios`  (
  ...
  `reg_pagospermisionarios_fechahora` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `usuarios`  (
  ...
  `usuarios_fechaalta` datetime(0) NULL DEFAULT NULL,
